...
// Пример распределения задачи на потоки
//**************************************

// Один поток считает свой интервал чисел, последующие 9 - свои. Записывают результат своего таска в переменную,
// которая ложится в лист и складывается с другими результатами тасок других потоков
